...
from ._growth import grow_string as _grow_string
from ._optimization import optimize_string as _optimize_string
...
class MainGSM(GSM):
    def grow_string(self, max_iters=30, max_opt_steps=3, nconstraints=1):
        return _grow_string(self, max_iters=max_iters, max_opt_steps=max_opt_steps, nconstraints=nconstraints)

    def optimize_string(self, max_iter=30, nconstraints=1, opt_steps=1, rtype=2):
        return _optimize_string(self, max_iter=max_iter, nconstraints=nconstraints, opt_steps=opt_steps, rtype=rtype)
